...
This branch supports **Part 4: Locators and Actions** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Locators, Navigation and Element Actions

**What this branch is used for:**
Playwright locators, navigation, click, fill, select, keyboard, hover
...
Use this branch while recording Part 4. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
