...
This branch supports **Part 12: Reports and CI** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Reports, Parallel Execution and GitHub Actions CI

**What this branch is used for:**
tags, profiles, reports, screenshots, traces, parallel, CI final review
...
Use this branch while recording Part 12. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
