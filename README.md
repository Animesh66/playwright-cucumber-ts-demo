...
This branch supports **Part 6: Data Driven BDD** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Scenario Outline, Data Tables and Test Data

**What this branch is used for:**
Examples tables, Data Tables, Doc Strings, reusable test data
...
Use this branch while recording Part 6. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
