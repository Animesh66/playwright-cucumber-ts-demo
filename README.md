...
This branch supports **Part 11: API and Hybrid Tests** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** API Testing and UI API Hybrid Tests

**What this branch is used for:**
Playwright request context, products/auth/orders API, API setup for UI
...
Use this branch while recording Part 11. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
