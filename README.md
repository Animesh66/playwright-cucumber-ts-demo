...
This branch supports **Part 1: Introduction to BDD Automation** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Playwright Cucumber TypeScript Full Course Introduction

**What this branch is used for:**
BDD mindset, Gherkin basics, tool roles, final framework walkthrough
...
Use this branch while recording Part 1. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
