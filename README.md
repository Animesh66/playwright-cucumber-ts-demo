...
This branch supports **Part 5: Assertions and Debugging** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Assertions, Waits and Debugging Basics

**What this branch is used for:**
web-first assertions, avoiding hard waits, screenshots and failure analysis
...
Use this branch while recording Part 5. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
