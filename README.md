...
This branch supports **Part 10: Cart and Checkout** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Automate Cart, Checkout and End-to-End UI Flow

**What this branch is used for:**
cart actions, checkout validation, confirmation and negative paths
...
Use this branch while recording Part 10. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
