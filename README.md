...
This branch supports **Part 7: Hooks and World** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Hooks, Browser Context and Custom World

**What this branch is used for:**
Before/After hooks, isolated browser context, shared scenario state
...
Use this branch while recording Part 7. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
