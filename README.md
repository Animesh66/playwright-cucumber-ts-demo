...
This branch supports **Part 8: Page Object Model** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Page Object Model Framework Design

**What this branch is used for:**
Base page, Login/Register/Shop pages, thin step definitions
...
Use this branch while recording Part 8. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
