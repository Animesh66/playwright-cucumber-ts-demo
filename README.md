...
This branch supports **Part 3: First BDD Test** in the updated 12-video Learn With Animesh playlist.

## Current Lecture

**YouTube Topic:** Write Your First Feature File and Step Definition

**What this branch is used for:**
Given/When/Then, matching step definitions, first browser run
...
Use this branch while recording Part 3. Start from the feature file or setup file related to the topic, explain the concept in beginner-friendly language, then run the matching Cucumber command and show the result.
